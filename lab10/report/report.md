...
![Пингование устройств с dep-donskaya-shuvayev-1](image/22.png){#fig:022 width=70%}
...
![Проверка доступности устройств с dk-donskaya-shuvayev-1](image/24.png){#fig:024 width=70%}
