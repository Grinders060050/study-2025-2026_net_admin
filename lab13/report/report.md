...
![Первоначальная настройка маршрутизатора msk-q42-shuvayev-gw-1](image/11.png){#fig:011 width=70%}

![Первоначальная настройка коммутатора msk-q42-shuvayev-sw-1](image/12.png){#fig:012 width=70%}

![Первоначальная настройка маршрутизирующего коммутатора msk-hostel-shuvayev-gw-1](image/13.png){#fig:013 width=70%}

![Первоначальная настройка коммутатора msk-hostel-shuvayev-sw-1](image/14.png){#fig:014 width=70%}

![Первоначальная настройка коммутатора sch-sochi-shuvayev-sw-1](image/15.png){#fig:015 width=70%}

![Первоначальная настройка маршрутизатора sch-sochi-shuvayev-gw-1](image/16.png){#fig:016 width=70%}
