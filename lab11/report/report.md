...
![Схема сети с NAT](image/1.png){#fig:001 width=70%}
...
![Схема L1 сети с выходом в Интернет](image/2.png){#fig:002 width=70%}
...
![Схема L2 сети с выходом в Интернет](image/3.png){#fig:003 width=70%}

![Схема L3 сети с выходом в Интернет](image/4.png){#fig:004 width=70%}
...
![Схема сети с выходом в Интернет](image/10.png){#fig:010 width=70%}
...
![Добавление DNS-записей](image/13.png){#fig:013 width=70%}
